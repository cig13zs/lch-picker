...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/lch-picker/](https://cig13zs.github.io/lch-picker/) or install the offline Chrome Extension package.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/lch-picker.git
   ```
